...
export default function Home() {
  return (
    <>
      ...
      <div className="max-w-[1512px] mx-auto px-6 py-10 border-b border-gray-100 flex justify-center">
        <p className="text-secondary text-[17px] leading-relaxed max-w-3xl text-center">
