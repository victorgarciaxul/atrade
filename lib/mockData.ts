...
// Solo se muestran los artículos con contenido real. El resto están ocultos.

const ariema: Article = {
  id: 2,
...
const aceitunastorrent: Article = {
  id: 3,
...
export const allArticles: Article[] = [samafrava, antonioespana, planho];
