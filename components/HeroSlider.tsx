...
export default function HeroSlider({ slides }: HeroSliderProps) {
  ...
  return (
    <div
      ...
      style={{ aspectRatio: "1921 / 681", maxHeight: "681px" }}
      ...
      {slides.map((s, i) => (
        <div
          ...
          style={{
            ...
            backgroundColor: s.isBanner ? "#071a4a" : undefined,
          }}
        >
          {/* Imagen de fondo */}
          <Image
            ...
            style={s.isBanner ? { objectPosition: "center top" } : undefined}
            priority={i === 0}
            sizes="100vw"
          />
          {/* Gradiente y contenido solo si no es banner */}
          {!s.isBanner && (
            <>
